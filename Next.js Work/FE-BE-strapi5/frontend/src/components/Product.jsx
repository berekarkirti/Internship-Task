...
//     // Delete handler using documentId
...
//                         className="border border-gray-300 p-3 rounded-lg w-full sm:w-1/3 bg-white shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
//                     />
//                     <select
//                         aria-label="Filter by category"
//                         value={selectedCategory}
//                         onChange={(e) => setSelectedCategory(e.target.value)}
//                         className="border border-gray-300 p-3 rounded-lg w-full sm:w-1/4 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
//                     >
