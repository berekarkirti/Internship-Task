// // app/login/page.jsx (corrected to use the correct file name convention)
// "use client";
...
//   const { login } = useUser() || {}; // Fallback to empty object if context is undefined
...
//       await login(token, email); // Fetch and set user data
...
import { useRouter } from "next/navigation";
import axios from "axios";
import { useUser } from "@/components/UserContext"; // Updated import path
